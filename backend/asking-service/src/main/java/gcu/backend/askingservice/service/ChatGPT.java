...
public class ChatGPT {
    ...
    public String generateText(String request) {
        ...
        ArrayList<Map<String, Object>> messageArray = new ArrayList<Map<String, Object>>();
        ...
        ArrayList<Map<String, Map>> responseArray = (ArrayList) response.getBody().get("choices");

        log.info(responseArray.get(0).get("message").get("content").toString());
        return responseArray.get(0).get("message").get("content").toString();
        // return
        // response.getBody().get("choices").get("message").get("content").toString();
    }
}
