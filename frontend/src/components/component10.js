...
const Component10 = (props) => {
    ...
    const Content = () => <div style={{
        ...
        <p style={{ fontWeight: 'bold', fontSize: '37px', margin: '0px 0px 10px 0px' }}>{props.Keyword}</p>
        <p style={{ fontWeight: 'lighter', lineHeight: '30px', fontSize: '19px' }}>{props.ExplainIn2sentence.map((content) => <>{content}<br /></>)}</p>
    </div>
    return (
